...
export const getUserProfile = userId => {
  ...
  const fetchUserProfile = axios.get(
...
export const getUserName = userId => {
  ...
  const fetchUserName = axios.get(
    `${backendURL}/api/user/${userId}/name`,
    options
  );
...
export const getGroupItems = groupId => {
  ...
  const endpoint = axios.get(
    `${backendURL}/api/item/group/${groupId}`,
    options
  );
...
export const getGroupTasks = groupId => {
  ...
  const endpoint = axios.get(
    `${backendURL}/api/task/group/${groupId}`,
    options
  );
...
export const deleteTask = (task, id) => {
  ...
  const endpoint = axios.delete(
    `${backendURL}/api/task/${deleteTaskId}`,
    options
  );
...
export const deleteComment = (comment, id) => {
  ...
  const endpoint = axios.delete(
    `${backendURL}/api/comment/${deleteCommentId}`,
    options
  );

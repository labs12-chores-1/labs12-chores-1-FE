...
>>>>>>> parent of 9a638d8... Latest work (without testing) on getting the current group ID stored on the global state, and getting the list of users under the current groupfor the GroupTasks page'

  ...
  render() {
    return (
      <MDBContainer className="task-detail-container">
        <MDBRow>
          <MDBCol md="12" className="mb-4">
            <div onClick={this.backToTask}>
              <MDBIcon className="card-link" icon="chevron-left" />
              Back to Task
            </div>
            <div className="nav-btns">
              <MDBBtn onClick={this.toggleMod} outline color="success">
                Edit Task
              </MDBBtn>
              {/* <MDBBtn onClick={this.toggle} outline color="success">Add Comment</MDBBtn> */}
              <MDBBtn outline color="success" onClick={this.removeTask}>
                Delete Task
              </MDBBtn>
            </div>
          </MDBCol>
        ...
        >
          <span className="x" onClick={this.toggleMod}>
            X
          </span>
          <form onSubmit={this.updateTask}>
            <div className="input-field">
              ...
              <MDBBtn outline color="success" onClick={this.updateTask}>
                Submit change
              </MDBBtn>
            </div>
            {/* <div className="input-field">
